...
analyze_nafld_singlegene <- function(Gene) {
  ...
  # **Step 3: 创建 ggplot 对象**
  plots <- list(
    plot_GSE130970 = analyze_gene_expression_GSE130970(Gene_hum, vsd_nafld_GSE130970, colData_GSE130970, "nafld"),
    plot_GSE89632 = analyze_gene_expression_GSE89632(Gene_hum, Illumina_GSE89632, colData_GSE89632, "nafld"),
    plot_GSE48452 = analyze_gene_expression_GSE48452(Gene_hum, Affymetrix_GSE48452, colData_GSE48452, "nas"),
    plot_GSE135251 = analyze_gene_expression_GSE135251(Gene_hum, vsd_nas_GSE135251, colData_GSE135251, "nas"),
    plot_GSE174478 = analyze_gene_expression_GSE174478(Gene_hum, vsd_nafld_GSE174478, colData_GSE174478, "nafld"),
    plot_GSE185051 = analyze_gene_expression_GSE185051(Gene_hum, vsd_nas_GSE185051, colData_GSE185051, "nas"),
    plot_GSE193066 = analyze_gene_expression_GSE193066(Gene_hum, vsd_nafld_GSE193066, colData_GSE193066, "nafld"),
    plot_GSE193080 = analyze_gene_expression_GSE193080(Gene_hum, vsd_nafld_GSE193080, colData_GSE193080, "nafld"),
    plot_GSE207310 = analyze_gene_expression_GSE207310(Gene_hum, vsd_nafld_GSE207310, colData_GSE207310, "nafld"),
    plot_GSE246221 = analyze_gene_expression_GSE246221(Gene_hum, vsd_nafld_GSE246221, colData_GSE246221, "nafld"),
    plot_GSE225740 = analyze_gene_expression_GSE225740(Gene_hum, vsd_nas_GSE225740, colData_GSE225740, "nas")
  )
  ...
  combined_plot <- plot_grid(plotlist = plots, ncol = 6)
  
  # 显示拼接图
  print(combined_plot)
}
# 单基因分析
analyze_nafld_singlegene("TRIP6")
